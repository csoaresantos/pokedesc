...
import com.example.poke_desc.data.api.ApiHelperImpl
import com.example.poke_desc.data.api.ApiService
...
val appModule = module {
    ...
    single { provideRetrofit(get(), BuildConfig.BASE_SERVICE_URL) }
